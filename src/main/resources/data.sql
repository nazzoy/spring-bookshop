insert into books (author, title, priceOld, price) values ('Drucie Goodbourn', 'exploit real time e-commerce', '$203.23', '$34.96');
insert into books (author, title, priceOld, price) values ('Marcia Agjiss', 'utilize real-time interfaces', '$260.31', '$35.96');
...
insert into books (author, title, priceOld, price) values ('Joanna Huttfield', 'scale integrated architectures', '$257.66', '$32.97');
insert into books (author, title, priceOld, price) values ('Dannie Glidder', 'e-enable frictionless web services', '$288.19', '$90.52');
insert into books (author, title, priceOld, price) values ('Timmie Adshdee', 'strategize B2B channels', '$232.27', '$44.83');
